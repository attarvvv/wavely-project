...
import { Volume2, Volume1, VolumeX, Plus, SkipBack, SkipForward, Play, Pause, Clock } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen text-white relative bg-gradient-to-b from-black via-[#050510] to-black">
      ...
      {/* ── MAIN CONTENT ── */}
      <div className="flex-1 px-4 md:px-6 pt-6 pb-36 relative z-10 overflow-auto">
        {/* Greeting */}
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-medium">Good Evening, Attar!</h1>
          ...
          <div className="grid grid-cols-3 gap-3 mb-8">
            ...
            {featuredSong && (
              <div
                ...
                className="col-span-2 flex items-center gap-4 bg-white/[0.04] border border-white/[0.08] rounded-2xl p-4 cursor-pointer hover:bg-blue-500/10 hover:border-blue-500/30 transition group"
              >
                <img
      ...
      {/* ── PLAYER BAR ── */}
      {currentSong && (
        <div className="fixed bottom-0 left-0 md:left-[220px] right-0 bg-[#080810]/90 backdrop-blur-2xl border-t border-white/[0.08] px-5 py-3 z-50">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col items-center gap-2 flex-1">
              <div className="flex items-center gap-4">
                <button onClick={playPrevSong} className="text-white/50 hover:text-white transition">
                  <SkipBack size={18} />
                </button>
                <button
                  onClick={togglePlay}
                ...
                <button onClick={playNextSong} className="text-white/50 hover:text-white transition">
                  <SkipForward size={18} />
                </button>
              </div>
              ...
              <div className="flex items-center gap-2 w-full">
                ...
                <div className="relative flex-1 h-1 group/prog">
                  <input
                    type="range"
                    min="0"
                    max={duration || 0}
            ...
            <div className="flex items-center gap-2 w-[28%] justify-end">
              {volume === 0 ? (
                ...
                <Volume1 size={15} className="text-white/40" />
              ) : (
